...
class USIGN:
	...
	def toNative(self, architecture, version): # Stick this in a superclass
		return toNative(self,self.TE_TYPE,architecture,version)
		
	def toCanonical(self, nativeNBT, architecture, version): # Stick this in a superclass
		return fromNative(self, nativeNBT, self.TE_TYPE,architecture,version)
...
#	bedrocksign = usign.toCanonical("BEDROCK","1_2")
	...
	print usign, javasign, bedrocksign, usignFromJava, usignFromBedrock
